...
export const DataImportSample = ({ sampleFileName: exportFileName, sampleData: initialData, allowUpdate = true, ...props }) => {
    ...
    return (_jsxs("div", { className: "rcm-import-sample", children: [_jsxs("div", { className: "rcm-import-sample-guide", children: [_jsx("p", { className: "rcm-import-sample-guide-text", children: t('form.list.dataTransfer.tab.import.messages.guide') }), _jsx(SampleDataButton, { exportKey: exportKey, setExportKey: setExportKey, setProcessing: setProcessing, processing: processing, data: sampleData, fileName: exportFileName, fields: fields })] }), hasRequired && (_jsxs("div", { className: "rcm-import-sample-required-notice", children: [_jsx("span", { className: "rcm-import-sample-required-star", children: "*" }), _jsx("span", { className: "rcm-import-sample-required-text", children: "\uD45C\uC2DC\uAC00 \uC788\uB294 \uD544\uB4DC\uB294 \uD544\uC218 \uD56D\uBAA9\uC785\uB2C8\uB2E4. \uD544\uC218 \uD56D\uBAA9\uC744 \uC785\uB825\uD558\uC9C0 \uC54A\uC73C\uBA74 \uC5C5\uB85C\uB4DC \uB418\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4." })] })), _jsx("div", { className: "rcm-import-sample-table-wrap", children: _jsx(SafePerfectScrollbar, { style: { minWidth: '100%' }, children: _jsxs(Table, { style: { minWidth: 650 }, "aria-label": "simple table", children: [_jsx(Table.Thead, { children: _jsx(Table.Tr, { children: fields.map((field, index) => {
                                    ...
                                    return (_jsx(Table.Tr, { children: fields.map((field, index) => {
                                            if (field.getName() === 'id') {
                                                return (_jsx(Table.Td, { align: "center", className: "rcm-import-sample-td", children: _jsxs("div", { className: 'rcm-import-sample-td-id', children: [_jsx("span", { className: "rcm-import-sample-td-id-label", children: `ID 값` }), _jsx(Tooltip, { zIndex: 10000, label: '\uAC12\uC774 \uC788\uC73C\uBA74 UPDATE, \uC5C6\uC73C\uBA74 INSERT', children: _jsx(IconHelpCircle, { className: 'rcm-import-sample-td-id-help' }) })] }) }, `body_${field.getName()}_${index + 1}`));
                                            }
                                            let value = '';
                                            for (const data of row) {
