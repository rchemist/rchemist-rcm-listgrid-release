...
const SampleDataButton = (props) => {
    const setProcessing = props.setProcessing ??
    ...
    return (_jsxs(_Fragment, { children: [props.processing && (_jsx(Modal, { size: 'lg', opened: props.processing, closeOnClickOutside: false, zIndex: 10000, onClose: () => {
                    setProcessing(false);
                        ...
                        setProcessing(false);
                    } }, 'data_export_import_data' + props.exportKey) })), !props.processing && (_jsxs("button", { type: "button", className: "rcm-button rcm-import-sample-download-btn", "data-variant": "primary", onClick: () => {
                    setProcessing(true);
                }, children: [_jsx(IconFile, { className: "rcm-m2o-action-icon" }), "\uC0D8\uD50C \uD30C\uC77C \uB2E4\uC6B4\uB85C\uB4DC"] }))] }));
};
