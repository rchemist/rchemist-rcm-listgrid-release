...
export const DataImportProcessor = ({ resultView, data, importResult, onSubmit, cancelImport, onImportSuccess, viewError, importErrorView, importError, errorMessage, preview, ...props }) => {
    ...
    return (_jsx(_Fragment, { children: _jsxs(Box, { children: [resultView && _jsxs(Box, { children: [_jsx(Box, { style: { padding: `2rem` }, children: _jsx(DataImportResultView, { result: importResult, fields: fields }) }), _jsx(Flex, { align: 'center', style: { width: '100%', paddingTop: 2 }, justify: 'center', children: _jsx("button", { type: "button", className: "btn btn-outline-primary border border-blue-500 text-blue-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => {
                                    cancelImport();
                                    onImportSuccess?.call(this);
                                }, children: "\uD655\uC778" }) })] }), !resultView && _jsxs(Box, { children: [viewError && _jsxs(Box, { style: { padding: `2rem` }, children: [_jsx(ImportErrorView, { importError: importError, importErrorView: importErrorView, errorMessage: errorMessage }), _jsx(Flex, { align: 'center', style: { width: '100%', marginTop: `2rem` }, justify: 'center', children: _jsx("button", { type: "button", className: "btn btn-outline-secondary border border-gray-500 text-gray-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2", onClick: () => {
                                            cancelImport();
                                        }, children: "\uB2EB\uAE30" }) })] }), preview && _jsxs(Box, { style: { padding: `2rem` }, children: [_jsx(DataImportPreview, { data: data, fields: fields }), _jsxs(Flex, { gap: 10, align: 'center', style: { width: '100%', marginTop: `2rem` }, justify: 'center', children: [_jsx("button", { type: "button", className: "btn btn-primary text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => {
                                                onSubmit();
                                            }, children: "\uC5C5\uB85C\uB4DC" }), _jsx("button", { type: "button", className: "btn btn-outline-primary border border-blue-500 text-blue-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => {
                                                cancelImport();
                                            }, children: "\uCDE8\uC18C" })] })] })] })] }) }));
};
