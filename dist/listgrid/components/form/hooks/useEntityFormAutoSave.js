 ...
 */
export function useEntityFormAutoSave({ entityForm, enabled, autoSaveKey, }) {
    ...
    // 현재 필드 값들을 가져오기
    const getFieldValues = useCallback(async () => {
        if (!entityForm)
            return {};
        const values = {};
    ...
    const saveToStorage = useCallback(async () => {
        if (!enabled || !entityForm || typeof window === 'undefined')
            return;
...
//# sourceMappingURL=useEntityFormAutoSave.js.map