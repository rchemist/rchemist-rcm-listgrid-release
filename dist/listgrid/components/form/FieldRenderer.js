...
export const FieldRenderer = (props) => {
    ...
    return (_jsxs("div", { id: `field-${instanceId}-${name}`, "data-field-name": name, className: classNames.field?.container, children: [_jsxs("div", { id: `field-${instanceId}-${name}-${version}`, className: cn(`flex items-center ${showTooltip ? "justify-between" : ""} -mb-0.5`, classNames.field?.labelWrapper), children: [_jsxs("div", { className: "flex items-center", children: [!hideLabel && (_jsx("label", { className: cn("text-gray-500 dark:text-gray-400 text-xs md:text-sm", classNames.field?.label), children: viewLabel(label) })), manyToOneLink, required && (_jsx(Tooltip, { label: "필수값", color: "red", withArrow: true, children: _jsx("div", { className: "mb-0.5 md:mb-1", children: _jsx(Icon, { icon: "healthicons:star-small", className: cn("cursor-help text-red-600 w-2.5 h-2.5 md:w-3 md:h-3", classNames.field?.requiredIcon) }) }) })), dirty && (_jsx(Tooltip, { label: "수정됨", color: "yellow", withArrow: true, children: _jsx("div", { className: "mb-0.5 md:mb-1", children: _jsx(Icon, { icon: "healthicons:star-small-outline", className: cn("cursor-help text-yellow-600 w-2.5 h-2.5 md:w-3 md:h-3", classNames.field?.dirtyIcon) }) }) }, `tooltip-${name}-${version}-dirty`))] }), showTooltip && (_jsx("div", { className: "flex items-center", children: _jsx(Tooltip, { label: tooltip, color: "gray", withArrow: true, position: "top-end", children: _jsx("div", { className: cn("text-[11px] text-white-dark", classNames.field?.tooltipIcon), children: _jsx(IconHelp, { className: "h-2.5 w-2.5 md:h-3 md:w-3" }) }) }) }))] }), _jsx("div", { className: cn("max-w-full text-wrap", classNames.field?.valueContainer), children: CustomFieldRenderer ? (_jsx(CustomFieldRenderer, { field: field, entityForm: entityForm, setEntityForm: setEntityForm, value: currentValue, onChange: handleFieldChange, onError: handleFieldError, clearError: handleClearError, required: required, readonly: _readonly ?? false, session: props.session, helpText: helpText, placeholder: _placeHolder, subCollectionEntity: subCollectionEntity, resetEntityForm: props.resetEntityForm })) : (view) }), _jsx(ViewFieldError, { errors: errors }), _jsx(ViewHelpText, { helpText: helpText })] }));
    /**
     * viewLabel
