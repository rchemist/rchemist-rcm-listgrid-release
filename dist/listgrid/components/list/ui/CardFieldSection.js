...
const CardFieldRow = ({ field, item, entityForm, session }) => {
    ...
    return (_jsxs("div", { className: "grid grid-cols-3 gap-3 py-2.5 border-b border-gray-50 dark:border-gray-800/50 last:border-b-0", children: [_jsxs("dt", { className: "flex items-center gap-1 text-xs text-gray-500 dark:text-gray-400 font-medium", children: [_jsx("span", { children: label }), required && (_jsx(Tooltip, { label: "\uD544\uC218\uAC12", color: "red", withArrow: true, children: _jsx(Icon, { icon: "healthicons:star-small", className: "cursor-help text-red-600 w-2.5 h-2.5" }) })), showTooltip && (_jsx(Tooltip, { label: tooltip, color: "gray", withArrow: true, position: "top-end", children: _jsx(IconHelp, { className: "h-3 w-3 text-gray-400 cursor-help" }) }))] }), _jsx("dd", { className: "col-span-2 text-sm text-gray-900 dark:text-gray-100", children: isLoading ? (_jsx("span", { className: "inline-block h-4 w-20 animate-pulse rounded bg-gray-100 dark:bg-gray-800" })) : (_jsxs("div", { className: "space-y-1", children: [_jsx("div", { children: renderedValue }), showHelpText && (_jsx("div", { className: "text-xs text-gray-400 dark:text-gray-500", children: helpText }))] })) })] }));
};
export const CardFieldSection = ({ fieldGroup, fields, item, entityForm, session, }) => {
    ...
    return (_jsxs("div", { className: "rounded-lg border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30 overflow-hidden", children: [hasLabel && (_jsx("div", { className: "px-4 py-2.5 bg-gray-100/80 dark:bg-gray-800/80 border-b border-gray-100 dark:border-gray-700 cursor-pointer", onClick: handleToggle, children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h4", { className: "text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400", children: fieldGroup.label }), _jsxs("div", { className: "flex items-center gap-2", children: [hasDescription && (_jsx(Tooltip, { label: fieldGroup.description, color: "gray", withArrow: true, position: "top-end", children: _jsx(IconInfoCircle, { className: "h-4 w-4 text-gray-400 cursor-help" }) })), _jsx("button", { type: "button", className: "p-0.5 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors", "aria-label": isOpen ? 'Collapse' : 'Expand', children: _jsx(IconChevronUp, { className: `h-4 w-4 text-gray-400 transition-transform duration-200 ${isOpen ? '' : 'rotate-180'}` }) })] })] }) })), isOpen && (_jsx("dl", { className: "px-4 py-2", children: visibleFields.map((field) => (_jsx(CardFieldRow, { field: field, item: item, entityForm: entityForm, session: session }, field.getName()))) }))] }));
};
