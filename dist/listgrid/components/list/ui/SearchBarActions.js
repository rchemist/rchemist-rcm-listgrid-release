...
export const SearchBarActions = (props) => {
    ...
    return (_jsxs("div", { className: containerClass, children: [showPageSize && (_jsx("div", { className: "rcm-search-bar-pagesize", children: _jsx("div", { className: "rcm-search-bar-pagesize-select", children: _jsx(SelectBox, { required: true, name: `pageSizeSelector`, options: pageSizeOptions, value: isValidOption ? currentPageSize : DEFAULT_PAGE_SIZE_VALUE, onChange: handlePageSizeChange, menuPortalTarget: typeof document !== 'undefined' ? document.body : undefined }) }) })), enableHandleData && (_jsx("div", { className: subCollection ? "" : "rcm-hide-below-sm", children: _jsx(ViewFieldSelector, { viewFields: viewFields, setViewFields: setViewFields, fields: listFields, disabled: loading, entityUrl: entityUrl, subCollectionName: subCollectionName }) })), !hideAdvancedSearch && (_jsx(Tooltip, { label: `${searchEnabled ? '통합 검색' : '통합 검색을 지원하지 않습니다.'}`, children: filtered ? (_jsx(Indicator, { color: "red", processing: true, children: _jsx("button", { className: 'rcm-button rcm-button-primary rcm-search-bar-submit', disabled: loading || !searchEnabled, onClick: () => onOpenAdvancedSearch?.(), children: "\uD1B5\uD569 \uAC80\uC0C9" }) })) : (_jsx("button", { className: 'rcm-button rcm-button-primary rcm-search-bar-submit', disabled: loading || !searchEnabled, onClick: () => onOpenAdvancedSearch?.(), children: "\uD1B5\uD569 \uAC80\uC0C9" })) }))] }));
};
