...
export const SearchBarActions = (props) => {
    ...
    const containerClass = cn('flex my-4 mb-2 lg:my-2 md:my-0 justify-end gap-2', themeClasses.searchBarActions?.container);
    ...
    return (_jsxs("div", { className: containerClass, children: [showPageSize && (_jsx("div", { className: "flex items-center space-x-2 md:mr-2 justify-end", children: _jsx("div", { className: "w-[140px] min-w-[140px]", children: _jsx(SelectBox, { required: true, name: `pageSizeSelector`, options: pageSizeOptions, value: isValidOption ? currentPageSize : DEFAULT_PAGE_SIZE_VALUE, onChange: handlePageSizeChange, menuPortalTarget: typeof document !== 'undefined' ? document.body : undefined }) }) })), enableHandleData && (_jsx("div", { className: subCollection ? "" : "hidden sm:block", children: _jsx(ViewFieldSelector, { viewFields: viewFields, setViewFields: setViewFields, fields: listFields, disabled: loading, entityUrl: entityUrl, subCollectionName: subCollectionName }) })), !hideAdvancedSearch && (_jsx(Tooltip, { label: `${searchEnabled ? '통합 검색' : '통합 검색을 지원하지 않습니다.'}`, children: filtered ? (_jsx(Indicator, { color: "red", processing: true, children: _jsx("button", { className: 'btn btn-primary flex items-center justify-center whitespace-nowrap', disabled: loading || !searchEnabled, onClick: () => onOpenAdvancedSearch?.(), children: "\uD1B5\uD569 \uAC80\uC0C9" }) })) : (_jsx("button", { className: 'btn btn-primary flex items-center justify-center whitespace-nowrap', disabled: loading || !searchEnabled, onClick: () => onOpenAdvancedSearch?.(), children: "\uD1B5\uD569 \uAC80\uC0C9" })) }))] }));
};
