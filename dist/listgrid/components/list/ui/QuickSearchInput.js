...
export const QuickSearchInput = ({ search, setSearch, onQuickSearch, quickSearchEnabled, quickSearchLabel, loading }) => {
    ...
    return (_jsxs("div", { className: "rcm-quick-search-wrap", children: [_jsx("input", { type: "text", id: "quick-search", className: "rcm-quick-search-input", placeholder: `Search ${quickSearchLabel}`, value: search, readOnly: !quickSearchEnabled, disabled: loading || !quickSearchEnabled, onChange: (e) => setSearch(e.target.value), onKeyUp: (e) => {
                    if (e.key === 'Enter')
