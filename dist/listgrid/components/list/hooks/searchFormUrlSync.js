...
import { hasUrlParams } from './urlStateParsers';
/**
 ...
 */
export function searchFormToUrlState(searchForm, quickSearchPropertyName, orFields) {
    const urlState = {
        page: null,
        pageSize: null,
        q: null,
 ...
 */
export function urlStateToSearchForm(urlState, quickSearchPropertyName, baseSearchForm, orFields) {
 ...
 */
export function mergeUrlAndSessionState(urlState, sessionSearchForm, quickSearchPropertyName, orFields) {
 ...
 */
export function getQuickSearchFromSearchForm(searchForm, quickSearchPropertyName, orFields) {
 ...
 */
export function areUrlStatesEqual(a, b) {
    // Page
    if (a.page !== b.page)
        return false;
    // PageSize
...
//# sourceMappingURL=searchFormUrlSync.js.map