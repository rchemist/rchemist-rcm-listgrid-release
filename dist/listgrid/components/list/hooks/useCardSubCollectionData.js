 ...
 */
export function useCardSubCollectionData(fetchUrl, config) {
     ...
     */
    const fetchDataSimple = useCallback(async (signal) => {
        setLoading(true);
        setError(null);
        try {
            const url = getUrl(fetchUrl);
...
//# sourceMappingURL=useCardSubCollectionData.js.map