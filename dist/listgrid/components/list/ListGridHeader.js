...
export const ListGridHeader = (props) => {
    ...
    if (!viewable)
        return null;
    return (_jsxs(React.Fragment, { children: [_jsxs("div", { className: themeClasses.header?.container ?? "mt-2 flex flex-wrap items-start gap-2", children: [_jsx(HeaderTitle, { title: title, hideTitle: hideTitle }), _jsx("div", { className: themeClasses.header?.buttonGroup ?? "flex max-w-full shrink-0 flex-wrap items-center gap-2", children: _jsx(HeaderActionButtons, { ...props, headerButtons: headerButtons, checkedButtons: checkedButtons, setOpenDownload: setOpenDownload, setOpenUpload: setOpenUpload, neverDelete: isTrue(props.entityForm.neverDelete) }) })] }), !isSubCollection && _jsx(DataTransferModals, { openDownload: openDownload, setOpenDownload: setOpenDownload, openUpload: openUpload, setOpenUpload: setOpenUpload, dataTransferConfig: dataTransferConfig, searchForm: searchForm, title: title, refresh: refresh })] }));
};
