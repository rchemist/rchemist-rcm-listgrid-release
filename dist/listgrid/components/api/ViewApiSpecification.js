...
export const ViewApiSpecification = ({ method, response, formData, ...props }) => {
    const url = props.url;
    return _jsxs("div", { className: 'space-y-6', children: [_jsxs("div", { children: [_jsx(ShowTitle, { copyText: `${url}`, label: 'API URL' }), _jsxs("div", { className: "flex", children: [_jsx("div", { className: "bg-[#f1f2f3] dark:bg-[#1b2e4b] text-sm flex justify-center items-center rounded-l-md px-3 font-semibold border border-r-0 border-white-light dark:border-[#17263c]", children: method }), _jsx("div", { id: "addonsRightoutline", className: "form-input rounded-r-md rounded-l-none", children: url })] })] }), formData && _jsxs("div", { children: [_jsx(ShowTitle, { copyText: `${formData}`, label: 'Form Data' }), _jsx("div", { className: 'form-input font-normal bg-[#f1f2f3]/[50%] dark:bg-[#1b2e4b]', children: _jsx("div", { children: _jsx("pre", { children: formData }) }) })] }), _jsxs("div", { children: [_jsx(ShowTitle, { copyText: `${response}`, label: 'API 응답 결과' }), _jsx("div", { className: 'form-input font-normal bg-[#f1f2f3]/[50%] dark:bg-[#1b2e4b]', children: _jsx("div", { children: _jsx("pre", { children: response }) }) })] })] });
};
