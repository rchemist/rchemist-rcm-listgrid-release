...
export const SelectFieldRenderer = ({ name, value, fetchedValue, options, onChange, entityForm, reason, validateStatusChange, immediateChangeProps, disabled }) => {
    ...
    const getReasonConfigForStatusChange = useCallback((targetStatus) => {
    ...
    const handleStatusChange = useCallback(async (changeReason) => {
        if (isChangeDisabled)
            return;
        // id가 없으면 상태 변경 불가
        if (!entityForm.id) {
    ...
    const handleChangeClick = useCallback(() => {
        ...
        if (reasonConfig) {
            ...
            const modalId = openModal({
                title: '상태 변경',
                content: (_jsx(StatusChangeReasonModal, { currentStatus: originalValue, newStatus: selectedValue, options: options, reason: reasonConfig, onConfirm: (changeReason) => {
                        closeModal(modalId);
            ...
            showConfirm({
                ...
                message: `<p style="color: #e53e3e; font-size:11pt; margin-bottom: 8px;">※ 주의: 상태만 변경되며, 다른 변경 사항은 저장되지 않습니다.</p>` +
    ...
    return (_jsxs("div", { className: "flex items-start gap-3", children: [_jsx(RadioChip, { name: name, value: selectedValue, options: availableOptions, onChange: handleSelectChange, readonly: isReadonly }), hasChanged && (_jsxs("button", { type: "button", className: `
          ...
          `, onClick: handleChangeClick, disabled: isChangeDisabled, children: [isChanging ? (_jsxs("svg", { className: "animate-spin w-4 h-4", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", children: [_jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), _jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })) : (_jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 13l4 4L19 7" }) })), _jsx("span", { children: "\uBCC0\uACBD" })] }))] }));
};
//# sourceMappingURL=SelectFieldRenderer.js.map