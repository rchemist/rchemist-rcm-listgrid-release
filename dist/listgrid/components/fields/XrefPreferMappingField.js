...
export class XrefPreferMappingField extends FormField {
    ...
    renderInstance(params) {
        return (async () => {
            ...
            return (_jsx(XrefPreferMappingView, { ...inputParams, showPreferred: this.showPreferred, entityForm: this.entityForm, parentEntityForm: params.entityForm, filters: this.filters, preferredLabel: this.preferredLabel }));
        })();
    }
    /**
