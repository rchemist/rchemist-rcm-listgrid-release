...
export const PostCodeSelector = (props) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Flex, { gap: 10, children: [_jsx("button", { type: "button", className: "btn btn-primary text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => { setOpen(!open); }, children: "\uC8FC\uC18C \uCC3E\uAE30" }), (!required && !isBlank(postalCode)) &&
                        _jsx("button", { type: "button", className: "btn btn-outline-primary border border-blue-500 text-blue-500 px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => { removeAddress(); }, children: "\uC8FC\uC18C \uC81C\uAC70" })] }), open &&
                _jsx(Modal, { opened: open, onClose: () => {
                        initializeData();
                        setOpen(false);
                    }, closeOnClickOutside: true, closeOnEscape: true, 
                    /* lockScroll={true} */
                    position: "center", size: 'lg', zIndex: 11000, title: "\uC8FC\uC18C \uAC80\uC0C9", children: _jsxs("div", { style: { padding: `2rem` }, children: [_jsxs(Grid, { className: classes.row, gutter: 16, align: "center", children: [_jsx(Grid.Col, { span: 2, className: clsx(classes.title, 'text-right pr-2'), children: "\uC6B0\uD3B8\uBC88\uD638" }), _jsx(Grid.Col, { span: 10, children: _jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", value: postalCode, disabled: true, readOnly: true, className: "w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-700 text-sm" }), _jsx("button", { type: "button", className: "btn btn-primary text-white px-4 rounded-md whitespace-nowrap text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", onClick: () => {
                                                        setOpenDaumPostCode(true);
                                                    }, children: "\uC8FC\uC18C \uAC80\uC0C9" })] }) })] }), _jsxs(Grid, { className: clsx(classes.row, classes.subRow), gutter: 16, align: "center", children: [_jsx(Grid.Col, { span: 2, className: clsx(classes.title, 'text-right pr-2'), children: "\uC8FC\uC18C" }), _jsx(Grid.Col, { span: 10, children: _jsx("input", { type: "text", value: address1, placeholder: '주소 검색을 눌러 주소를 선택하세요', readOnly: true, disabled: true, className: "w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 text-gray-700 text-sm" }) })] }), !disabled &&
                                _jsxs(Grid, { className: clsx(classes.row, classes.subRow), gutter: 16, align: "center", children: [_jsx(Grid.Col, { span: 2, className: clsx(classes.title, 'text-right pr-2'), children: "\uC0C1\uC138 \uC8FC\uC18C" }), _jsxs(Grid.Col, { span: 10, children: [_jsx("input", { type: "text", value: address2, placeholder: '상세 주소를 입력하세요', onChange: (e) => {
                                                    ...
                                                    }, className: "w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm" }), !isBlank(error) &&
