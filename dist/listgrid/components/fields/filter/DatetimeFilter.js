...
export const DatetimeFilter = (props) => {
    ...
    function showButtons() {
        return (_jsxs("div", { className: 'flex gap-3 mt-2', children: [_jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
                    ...
                    }, children: "\uC624\uB298" }), _jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
                        handleValueChange('WEEK');
                    }, children: "1\uC8FC\uC77C" }), _jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
                        handleValueChange('MONTH');
                    }, children: "1\uAC1C\uC6D4" }), _jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
                        handleValueChange('MONTH3');
                    }, children: "3\uAC1C\uC6D4" }), _jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
                        handleValueChange('MONTH6');
                    }, children: "6\uAC1C\uC6D4" }), _jsx("button", { className: 'btn-sm border rounded-md flex items-center max-h-[24px] btn-outline-primary whitespace-nowrap', onClick: () => {
