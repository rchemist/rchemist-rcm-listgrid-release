...
export const RuleCondition = (props) => {
    ...
    if ((targetEntityForm.fields === undefined || targetEntityForm.fields.length === 0) && targetEntityForm.entityForm === undefined) {
        // 아무 것도 할 수 있는게 없다.
                    ...
                    return fieldValues.map((fieldValue, index) => {
                        ...
                        return _jsxs("div", { children: [_jsx("div", { className: 'font-bold mt-5', children: field?.label }), _jsxs("div", { className: 'flex gap-3 items-center', children: [_jsx("div", { className: 'min-w-[200px] max-w-[200px]', children: _jsx(SelectBox, { options: getQueryConditionTypes(field), value: fieldValue.queryConditionType, required: true, onChange: (type) => {
                                                ...
                                                if (currentValueType === 'SINGLE') {
                                                    ...
                                                    fields.push(_jsx("div", { className: 'w-full', children: _jsx(RuleFieldRenderer, { field: field.clone()
                                                    ...
                                                    if (field instanceof AbstractDateField) {
                                                        const cloned = field.clone(true).withRange(true).withValue(fieldValue.values);
                                                        ...
                                                        const currentValue1 = fieldValue.values !== undefined && fieldValue.values.length > 0 ? fieldValue.values[0] : '';
                                                        const currentValue2 = fieldValue.values !== undefined && fieldValue.values.length > 1 ? fieldValue.values[1] : '';
                                                ...
                                                changeFilterValues(newFieldValues);
                                            }, children: _jsx(IconCircleX, { className: "max-w-4" }) })] }), fieldErrors?.has(index) &&
                                    _jsx("div", { className: 'px-2', children: _jsx(ViewFieldError, { errors: [fieldErrors.get(index)] }) }), _jsx("div", { className: 'px-2', children: _jsx(ViewHelpText, { helpText: `${helpText}` }) })] }, index);
                    });
                }()] }) });
};
