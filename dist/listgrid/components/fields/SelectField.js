...
export class SelectField extends OptionalField {
    ...
    async renderViewInstance(props) {
        ...
        if (this.cardIcon) {
            ...
            return {
                result: (_jsxs("span", { className: "inline-flex items-center gap-2", children: [_jsx("span", { className: "flex items-center justify-center w-6 h-6 rounded-md bg-gray-100 dark:bg-gray-800", children: _jsx(IconComponent, { className: "h-3.5 w-3.5 text-gray-500 dark:text-gray-400 shrink-0", stroke: 1.75 }) }), _jsx(Badge, { color: color, children: displayLabel })] }))
            };
        }
        return {
