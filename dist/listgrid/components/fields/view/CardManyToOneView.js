...
export const CardManyToOneView = ({ field, entityForm, value, onChange, readonly, session, columns = 3, mobileColumns, gridClassName, cardConfig, items: providedItems, loadItems, emptyMessage = "선택 가능한 항목이 없습니다.", showSearchButton = true, showAllWhenEmpty = true, pageSize = 6, searchFirst = false, searchPlaceholder, searchFields = ['name'], }) => {
    ...
    const renderSelectedCard = useCallback((item) => {
        ...
        return (_jsxs("div", { className: cardConfig?.selectedContainerClassName ?? "rcm-card-m2o rcm-card-m2o-selected", children: [_jsx("div", { className: cardConfig?.checkIconClassName ?? "rcm-card-m2o-check", children: _jsx(IconCheck, { size: 14 }) }), image && (_jsx("div", { className: "rcm-card-m2o-image-wrap", children: _jsx("img", { src: image, alt: getTitle(item), className: "rcm-card-m2o-image" }) })), !isBlank(label) && (_jsx("span", { className: cardConfig?.labelClassName ?? "rcm-card-m2o-badge rcm-card-m2o-badge-primary", children: label })), _jsx("h4", { className: cardConfig?.titleClassName ?? "rcm-card-m2o-title", children: getTitle(item) }), !isBlank(description) && (_jsx("p", { className: cardConfig?.descriptionClassName ?? "rcm-card-m2o-description", children: description })), cardConfig?.renderAction && (_jsx("div", { className: "rcm-card-m2o-action", children: cardConfig.renderAction(item) }))] }, item.id));
    ...
    const renderSelectableCard = useCallback((item, selected, onSelect) => {
        ...
        return (_jsxs("div", { onClick: onSelect, className: `rcm-card-m2o rcm-card-m2o-clickable ${selected
                ...
                : (cardConfig?.containerClassName ?? "rcm-card-m2o-default")}`, children: [selected && (_jsx("div", { className: cardConfig?.checkIconClassName ?? "rcm-card-m2o-check", children: _jsx(IconCheck, { size: 14 }) })), image && (_jsx("div", { className: "rcm-card-m2o-image-wrap", children: _jsx("img", { src: image, alt: getTitle(item), className: "rcm-card-m2o-image" }) })), !isBlank(label) && (_jsx("span", { className: cardConfig?.labelClassName ?? "rcm-card-m2o-badge rcm-card-m2o-badge-neutral", children: label })), _jsx("h4", { className: cardConfig?.titleClassName ?? "rcm-card-m2o-title rcm-card-m2o-title-sm", children: getTitle(item) }), !isBlank(description) && (_jsx("p", { className: cardConfig?.descriptionClassName ?? "rcm-card-m2o-description rcm-card-m2o-description-clamp", children: description })), cardConfig?.renderAction && (_jsx("div", { className: "rcm-card-m2o-action", children: cardConfig.renderAction(item) }))] }, item.id));
    }, [cardConfig, getTitle, getLabel, getDescription, getImage]);
    if (loading) {
    ...
    if (selectedItem && !isChanging) {
        return (_jsxs("div", { className: "rcm-card-m2o-wrapper rcm-card-m2o-stack", children: [cardConfig?.renderCard
                    ? cardConfig.renderCard(selectedItem, true, () => { })
                    : renderSelectedCard(selectedItem), _jsxs("div", { className: "rcm-card-m2o-actions", children: [_jsxs("button", { type: "button", onClick: handleToggleChange, className: "rcm-card-m2o-action-btn rcm-card-m2o-action-btn-primary", children: [_jsx(IconEdit, { size: 16 }), "\uBCC0\uACBD"] }), _jsxs("button", { type: "button", onClick: handleClear, className: "rcm-card-m2o-action-btn rcm-card-m2o-action-btn-muted", children: [_jsx(IconX, { size: 16 }), "\uC120\uD0DD \uD574\uC81C"] })] })] }));
    }
    // 편집 모드: 변경 중이거나 선택된 카드가 없는 경우
    return (_jsxs("div", { className: "rcm-card-m2o-wrapper", children: [isChanging && selectedItem && (_jsxs("div", { className: "rcm-card-m2o-change-header", children: [_jsx("span", { className: "rcm-card-m2o-change-title", children: "\uB2E4\uB978 \uD56D\uBAA9\uC744 \uC120\uD0DD\uD574\uC8FC\uC138\uC694" }), _jsx("button", { type: "button", onClick: handleToggleChange, className: "rcm-card-m2o-change-cancel", children: "\uCDE8\uC18C" })] })), searchFirst && (_jsxs("div", { className: "rcm-card-m2o-search-section", children: [_jsxs("div", { className: "rcm-card-m2o-search-row", children: [_jsxs("div", { className: "rcm-card-m2o-search-input-wrap", children: [_jsx(IconSearch, { size: 18, className: "rcm-card-m2o-search-icon" }), _jsx("input", { type: "text", value: searchQuery, onChange: handleSearchChange, onKeyDown: handleSearchKeyDown, placeholder: searchPlaceholder ?? "검색어를 입력하세요...", className: "rcm-card-m2o-search-input" }), searchQuery && (_jsx("button", { type: "button", onClick: () => { setSearchQuery(""); setItems([]); setHasSearched(false); setCurrentPage(0); }, className: "rcm-card-m2o-search-clear", children: _jsx(IconX, { size: 16 }) }))] }), _jsxs("button", { type: "button", onClick: () => handleServerSearch(searchQuery), disabled: isSearching || isBlank(searchQuery.trim()), className: "rcm-card-m2o-search-submit", children: [isSearching ? (_jsx("div", { className: "rcm-card-m2o-spinner rcm-card-m2o-spinner-inverse" })) : (_jsx(IconSearch, { size: 16 })), "\uAC80\uC0C9"] })] }), (hasSearched || isSearching) && (_jsx("div", { className: "rcm-card-m2o-search-status", children: isSearching ? '검색 중...' : `검색 결과: ${items.length}건` }))] })), !searchFirst && needsPagination && (_jsxs("div", { className: "rcm-card-m2o-search-section", children: [_jsxs("div", { className: "rcm-card-m2o-search-input-wrap", children: [_jsx(IconSearch, { size: 18, className: "rcm-card-m2o-search-icon" }), _jsx("input", { type: "text", value: searchQuery, onChange: handleSearchChange, placeholder: "\uC774\uB984\uC73C\uB85C \uAC80\uC0C9...", className: "rcm-card-m2o-search-input" }), searchQuery && (_jsx("button", { type: "button", onClick: () => { setSearchQuery(""); setCurrentPage(0); }, className: "rcm-card-m2o-search-clear", children: _jsx(IconX, { size: 16 }) }))] }), _jsxs("div", { className: "rcm-card-m2o-search-status", children: ["\uCD1D ", filteredItems.length, "\uAC1C ", searchQuery && `(검색결과)`] })] })), searchFirst && !hasSearched ? (_jsxs("div", { className: "rcm-card-m2o-search-empty", children: [_jsx(IconSearch, { size: 32, className: "rcm-card-m2o-search-empty-icon" }), _jsx("p", { className: "rcm-card-m2o-search-empty-text", children: "\uAC80\uC0C9\uC5B4\uB97C \uC785\uB825\uD558\uACE0 \uAC80\uC0C9 \uBC84\uD2BC\uC744 \uD074\uB9AD\uD558\uC138\uC694" })] })) : paginatedItems.length > 0 ? (_jsxs("div", { id: `card-grid-${field.getName()}`, className: gridClassName ?? "rcm-card-m2o-grid", style: !gridClassName
                    ? {
            ...
            ` })), paginatedItems.map((item) => {
                    ...
                    })] })) : (_jsx("div", { className: "rcm-card-m2o-no-results", children: _jsx("p", { children: searchFirst && hasSearched ? "검색 결과가 없습니다." : (searchQuery ? "검색 결과가 없습니다." : emptyMessage) }) })), needsPagination && totalPages > 1 && (_jsxs("div", { className: "rcm-card-m2o-pagination", children: [_jsx("button", { type: "button", onClick: () => handlePageChange(currentPage - 1), disabled: currentPage === 0, className: "rcm-card-m2o-page-nav", children: _jsx(IconChevronLeft, { size: 18 }) }), _jsx("div", { className: "rcm-card-m2o-page-numbers", children: Array.from({ length: totalPages }, (_, i) => (_jsx("button", { type: "button", onClick: () => handlePageChange(i), className: `rcm-card-m2o-page ${currentPage === i ? 'rcm-card-m2o-page-active' : ''}`, children: i + 1 }, i))) }), _jsx("button", { type: "button", onClick: () => handlePageChange(currentPage + 1), disabled: currentPage >= totalPages - 1, className: "rcm-card-m2o-page-nav", children: _jsx(IconChevronRight, { size: 18 }) })] }))] }));
};
