...
export const PhoneNumberFieldView = ({ name, value, onChange, onError, readonly = false, placeHolder, regex, enableSms, session, renderType, }) => {
    ...
    return (_jsx("div", { className: "flex w-full", children: _jsxs("div", { className: "flex w-full items-center", children: [_jsx("div", { className: "group relative flex w-full", children: _jsx("div", { className: "dropdown flex w-full", children: _jsx("input", { type: "text", className: readonlyClass(readonly, `form-input ${showButtons ? 'rounded-r-none border-r-0' : ''}`), id: name, value: displayValue, placeholder: placeHolder, disabled: readonly, onChange: handleChange, onBlur: handleBlur }) }) }), showButtons && (_jsxs("div", { className: "flex h-full items-center border border-white-light bg-[#fafafa] font-semibold text-secondary dark:border-[#17263c] dark:bg-[#1b2e4b] rounded-r-md border-l-0", children: [canCopy && (_jsx(Tooltip, { label: "\uC804\uD654\uBC88\uD638 \uBCF5\uC0AC", children: _jsx("button", { type: "button", className: "flex h-[30px] w-[36px] items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700", onClick: handleCopy, children: _jsx(IconCopy, { className: "h-4 w-4" }) }) })), canSendSms && (_jsx(Tooltip, { label: "SMS \uBCF4\uB0B4\uAE30", children: _jsx("button", { type: "button", className: "flex h-[30px] w-[36px] items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700", onClick: handleSms, children: _jsx(IconMessage, { className: "h-4 w-4" }) }) }))] }))] }) }));
};
