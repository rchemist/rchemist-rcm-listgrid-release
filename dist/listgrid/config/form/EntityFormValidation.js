...
export class EntityFormValidation extends EntityFormBase {
    ...
    setFieldValidationState(fieldName, state) {
    ...
    withManageEntityForm(manageEntityForm) {
        this.manageEntityForm = manageEntityForm;
        return this;
    }
    withCreatable(creatable = true) {
        this.manageEntityForm.create = creatable;
        return this;
    }
    withUpdatable(updatable = true) {
        this.manageEntityForm.update = updatable;
        return this;
    }
    withDeletable(deletable = true) {
...
//# sourceMappingURL=EntityFormValidation.js.map